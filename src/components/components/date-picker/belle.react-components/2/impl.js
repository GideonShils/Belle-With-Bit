...
import map from 'bit/utils/map';
import shift from 'bit/utils/shift';
import reverse from 'bit/utils/reverse';
import omit from 'bit/utils/omit';
import uniqueId from 'bit/utils/unique-id';
import convertDateToDateKey from 'bit/utils/convert-date-to-date-key';
import getDateKey from 'bit/utils/get-date-key';
import getDateForDateKey from 'bit/utils/get-date-for-date-key';
import getWeekArrayForMonth from 'bit/utils/get-week-array-for-month';
import getLastDayForMonth from 'bit/utils/get-last-day-for-month';
import getLocaleData from 'bit/utils/get-locale-data';
import today from 'bit/utils/today';

import defaultStyle from 'bit/style/date-picker-style';
import config from 'bit/config/date-picker-config';

import ActionArea from 'bit/components/action-area';
import DisabledDay from 'bit/components/disabled-day';
import Day from 'bit/components/day';
...
export default class DatePicker extends Component {
  ...
  _onFocus = () => {
    ...
    if (this.props.onFocus) {
      this.props.onFocus(event);  // eslint-disable-line no-restricted-globals
    }
  };
  ...
  _onBlur = () => {
    ...
    if (this.props.onBlur) {
      this.props.onBlur(event); // eslint-disable-line no-restricted-globals
    }
  };
  ...
  _onTouchEnd = () => {
    ...
    if (this.props.onTouchEnd) {
      this.props.onTouchEnd(event); // eslint-disable-line no-restricted-globals
    }
  };
  ...
  _onTouchCancel = () => {
    ...
    if (this.props.onTouchCancel) {
      this.props.onTouchCancel(event);  // eslint-disable-line no-restricted-globals
    }
  };
  ...
  _onClickPrevMonth = () => {
    ...
    if (this.props.prevMonthNavProps && this.props.prevMonthNavProps.onClick) {
      this.props.prevMonthNavProps.onClick(event);  // eslint-disable-line no-restricted-globals
    }
  };
  ...
  _onClickNextMonth = () => {
    ...
    if (this.props.nextMonthNavProps && this.props.nextMonthNavProps.onClick) {
      this.props.nextMonthNavProps.onClick(event);  // eslint-disable-line no-restricted-globals
    }
  };
